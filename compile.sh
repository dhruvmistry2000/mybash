...
checkEnv() {
    ...
    echo "Using $PACKAGER as package manager and $ESCALATION_TOOL for privilege escalation."
}
...
installDepend() {
    ...
    case $PACKAGER in
        ...
        zypper)
            ...
            ;;
        *)
            $ESCALATION_TOOL "$PACKAGER" install -y $DEPENDENCIES # For other package managers
            ;;
    esac
}
