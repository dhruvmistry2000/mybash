...
export LESS_TERMCAP_md=$'\E[01;31m'  # Red (bold)
export LESS_TERMCAP_me=$'\E[0m'      # Reset text style
export LESS_TERMCAP_se=$'\E[0m'      # Reset text style
export LESS_TERMCAP_so=$'\E[01;44;33m' # Yellow text on blue background (standout)
export LESS_TERMCAP_ue=$'\E[0m'      # Reset underline
export LESS_TERMCAP_us=$'\E[01;32m'  # Green (underlined)
